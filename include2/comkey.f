      integer  NTYPE,NSBTYPE,NYEAR,NMONTH,NDAY,NHOUR,NMINUTE,
     +     NSECOND,NLAT1,NLON1,NLAT2,NLON2,NOBS,IDSAT,
     +     NLREC,NRDAY,NRHOUR,NRMIN,NRSEC,NCORR,NRECR,
     +     NNIL,NQC,NCORN,NPART,NBUFTYPE
C
